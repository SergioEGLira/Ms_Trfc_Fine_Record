...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.exceptionHandling().authenticationEntryPoint(authenticationEntryPoint).and().sessionManagement()
				...
				.antMatchers("/user/autuacao/**/getallautuacoesbyuseronlymytokencpf").hasAnyRole("ADMIN", "USER")

				.antMatchers("/user/**/onlymytokencpf").hasAnyRole("ADMIN", "USER")
