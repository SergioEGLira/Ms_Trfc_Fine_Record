...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] AUTH_WHITELIST = {
			...
			, "/autuacao/**/getAllAutuacoesByUser"
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.exceptionHandling().authenticationEntryPoint(authenticationEntryPoint).and().sessionManagement()
				...
				.antMatchers(AUTH_WHITELIST).permitAll().antMatchers("/automoveis/**", "/automoveis").hasRole("ADMIN")
				.antMatchers("/autuacao/**", "/autuacao").hasRole("ADMIN").antMatchers("/infracoes/**", "/infracoes")
				.hasRole("ADMIN")
